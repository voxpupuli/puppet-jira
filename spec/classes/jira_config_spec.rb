          ...
          context 'tomcat native ssl default params' do
            ...
            it do
              is_expected.to contain_file(FILENAME_SERVER_XML)
                ...
                .with_content(%r{<SSLHostConfig sslProtocol="TLS">})
                .with_content(%r{certificateKeyAlias="jira"})
                .with_content(%r{certificateKeystoreFile="/home/jira/jira.jks"})
                .with_content(%r{certificateKeystorePassword="changeit"})
                .with_content(%r{certificateKeystoreType="JKS"})
          ...
          context 'native ssl support custom params' do
            ...
            it do
              is_expected.to contain_file(FILENAME_SERVER_XML)
                ...
                .with_content(%r{certificateKeyAlias="keystorealias"})
                .with_content(%r{certificateKeystoreFile="/tmp/keyfile.ks"})
                .with_content(%r{certificateKeystorePassword="keystorepass"})
                .with_content(%r{certificateKeystoreType="PKCS12"})
